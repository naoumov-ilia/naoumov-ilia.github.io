...
– The line originating at f1, parallel to the current supply line, is crossed by the chart before the correction of the impulse wave (f1 : v2(t*)) is complete, (v2(t*) is the starting point of correction of the wave movement from f1 to t);
– The line originating at v1, parallel to the demand line, is crossed by the chart, except in the case of extension;
-The duration of the primary wave movement starting at f1 exceeds half the duration of (o1:f1), T21 > T1/2.
